...
const PlanDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://camping-crew.onrender.com/plan-details/${planId.id}`)
      .then((res) => res.json())
      .then((data) => {
        setPlanDetails(data);
      });
  ...
  useEffect(() => {
    fetch(`https://camping-crew.onrender.com/booking-details/${planId.id}`)
      .then((res) => res.json())
      .then((data) => {
        setJoinusers(data);
      });
  ...
  const bookPlan = (e) => {
    ...
    axios
      .post("https://camping-crew.onrender.com/add-booking", orderdata)
      .then((res) => {
        e.target.reset();
        setOrderdata({
          username: "",
